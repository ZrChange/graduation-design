...
<title>${siteName!""}|年级管理-添加年级</title>
    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加年级</h4></div>
              <div class="card-body">
                <form id="user-add-form" class="row">

                  <div class="input-group m-b-10">
                    <span class="input-group-addon">年级名称</span>
                    <input type="text" class="form-control required" id="name" name="name" value="" placeholder="请输入年级"
                           tips="请填写年级" />
                  </div>

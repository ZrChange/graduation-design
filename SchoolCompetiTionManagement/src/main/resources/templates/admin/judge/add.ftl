...
<title>${siteName!""}|评委管理-添加评委</title>
    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加评委</h4></div>
              <div class="card-body">
                <form action="add" id="judge-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="" placeholder="请输入评委姓名" tips="请填写评委姓名" />
                  </div>
                  <div class="input-group m-b-10">
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('评委添加成功!',function(){

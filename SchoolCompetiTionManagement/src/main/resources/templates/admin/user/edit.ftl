        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="add" id="user-edit-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="tel" class="form-control" id="edit-mobile" name="mobile" value="${user.mobile}" />
                  </div>
                  <div class="input-group m-b-10">
...
$(document).ready(function(){
	...
	$("#edit-form-submit-btn").click(function(){
        ...
        var mobiles = $("#edit-mobile").val();
        if (!phoneCheck.test(mobiles)) {
            showWarningMsg("请正确填写11位手机号");
            return;
        }
